...
/**
 * Created by ehsure on 2018/7/15.
 */
public class PackPlanHeaderDTO implements Serializable {
    private String id;
    private String code;
    ...
    private List<PackPlanDetailDTO> detailList = new ArrayList<>();
    ...
    public List<PackPlanDetailDTO> getDetailList() {
        return detailList;
    }

    public void setDetailList(List<PackPlanDetailDTO> detailList) {
