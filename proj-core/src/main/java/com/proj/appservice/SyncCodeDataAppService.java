 ...
 * @author arlenChen
 */
public interface SyncCodeDataAppService {
    /**
     * 同步 老系统生产数据
     *
     ...
     * @return re
     */
    List<PackPlanHeaderDTO> getPackPlanList(String beginTime, String endTime) throws SQLException;
     ...
     * @return re
     */
    List<ProductPlanHeaderDTO> getProductPlanList(String beginTime, String endTime) throws SQLException;
     ...
     * @return re
     */
    List<SSODataDTO> syncBillData(String beginTime, String endTime) throws SQLException;
